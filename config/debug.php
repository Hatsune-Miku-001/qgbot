...
const MIRAIEZ_ADMIN_QQ = ;                     //填写用于管理机器人，接收机器人通知的 qq

$MIRAIEZ_DEBUG_GROUPS = [];                        //启用调试的群组
$MIRAIEZ_DEBUG_FRIENDS = [];                      //启用调试的好友

const MIRAIEZ_ADAPTER_ALWAYS_USE_HTTP = false;           //只使用 HTTP 适配器
const MIRAIEZ_PLUGINS_DATA_ISOLATION = true;            //是否为不同的插件隔离数据 (即每个插件一个专用目录)
const MIRAIEZ_LOGGING_LEVEL = 0;                         //日志记录级别
